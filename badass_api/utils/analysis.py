...
class analysis:
    # Initialise models
    def __init__(self,emotion_model,detector,predictor,faceCascade):
        self.emotion_model = load_model("./models/distraction_model/emotion_recognition.h5")
    ...
    def detect_emotion(self, gray):
        ...
        if len(faces) > 0:
            for x, y, width, height in faces:
                ...
                # self.emotion_model = load_model("C:/Users/USER/adaptive_learnig/badass_api/models/distraction_model/emotion_recognition.h5")
